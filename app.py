#this will be containing the frontend interface of the project. using modules such as streamlit, pandas, and integraations with files like chatbot_logic will be established here. the heavy ifting for the frontend design will be done by stream lit module.
...
# --- Page Configuration ---
st.set_page_config(page_title="📊 AI [NLP] Chatbot", layout="wide", initial_sidebar_state="collapsed")

# --- Title and Description ---
st.title("📊 AI [NLP] Chatbot 🤖")
st.markdown("""
